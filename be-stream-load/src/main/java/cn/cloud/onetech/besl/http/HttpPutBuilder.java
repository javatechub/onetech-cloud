...
package cn.cloud.onetech.besl.http;

import cn.cloud.onetech.besl.constants.LoadConstants;
...
public class HttpPutBuilder {
    ...
    public HttpPutBuilder setFileFormat(String format) {
        header.put("format", format);
        return this;
    }

    public HttpPutBuilder setColumnSeparator(String columnSeparator) {
        header.put("column_separator", columnSeparator);
        return this;
    }
